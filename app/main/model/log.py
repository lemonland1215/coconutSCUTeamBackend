...
class Log(db.Model):
    ...
    type = db.Column(db.String(50), nullable=False, comment='Log类型：Error，Login，Logout，Create，Delete，Modify，Search，Targeted')
    operator_id = db.Column(db.INTEGER, nullable=False, comment='操作者id，如果是targeted的就是中招人id')
    role = db.Column(db.String(50), nullable=True, default='sysrole', comment='操作者身份')
